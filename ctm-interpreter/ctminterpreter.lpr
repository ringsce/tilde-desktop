...
uses
  SysUtils, Classes, fphttpclient, CLI,  opensslsockets;
...
var
  GitHubURL, OutputFile: string;
begin
  // Example: Download a file from GitHub
  GitHubURL := 'https://raw.githubusercontent.com/fpc/Lazarus/main/README.md';
  OutputFile := 'README.md';

  DownloadFromGitHub(GitHubURL, OutputFile);
end.
